...
import {SAMPLE_PHOTOS} from './SmallPhotoSet.js';
...
const paths = {
  ...
  $local: `${here}/../demo/photos/Library`
};
...
export const PhotoChooser = {
  async requestPhoto({fileSystem, maxPhotos, container, ...options}) {
...
const requirePrivateData = async (fileSystem) => {
  if (!privatePhotoData) {
