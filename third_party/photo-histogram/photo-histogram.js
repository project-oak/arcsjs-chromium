...
(function (PhotoHistogram) {
  ...
  var Ui = (function () {
    function Ui(parent, source, options) {
      ...
      var svgParent = parent.querySelector('#' + this.id.containerHistogram);
    ...
    Ui.prototype.selectedChannel = function () {
      return parseInt(this.parent.querySelector('#' +this.id.selectChannels).value, 10);
    };
    ...
    Ui.prototype._addEventListeners = function () {
      var hist = this;
      var element = this.parent.querySelector('#' + this.id.btnRefresh);
      element.addEventListener('click', function () {
        hist.refresh();
      });
      element = this.parent.querySelector('#' + this.id.btnStatsToggle);
      element.addEventListener('click', function () {
        var stats = this.parent.querySelector('#' +hist.id.containerStats);
        var button = this.parent.querySelector('#' +hist.id.btnStatsToggle);
        var containerHist = this.parent.querySelector('#' +hist.id.containerHistogram);
      ...
      element = this.parent.querySelector('#' +this.id.selectChannels);
      ...
      this.svgManager.element.addEventListener('mousedown', function (e) {
        ...
        var inputLevel = hist.parent.querySelector('#' +hist.id.inputLevel);
        var inputCount = hist.parent.querySelector('#' +hist.id.inputCount);
        var inputPercentile = hist.parent.querySelector('#' +hist.id.inputPercentile);
      ...
      this.svgManager.element.addEventListener('mousemove', function (e) {
        if (e.buttons > 0 && hist.prevMouseDownPoint != null) {
          ...
          var rect = hist.parent.querySelector('#' +hist.id.rectOverlay);
    ...
    Ui.prototype._updateStats = function () {
      var channel = this.selectedChannel();
      var inputMean = this.parent.querySelector('#' +this.id.inputMean);
      var inputMedian = this.parent.querySelector('#' +this.id.inputMedian);
      var inputMode = this.parent.querySelector('#' +this.id.inputMode);
      var inputStd = this.parent.querySelector('#' +this.id.inputStd);
      var inputPixels = this.parent.querySelector('#' +this.id.inputPixels);
      var inputLevel = this.parent.querySelector('#' +this.id.inputLevel);
      var inputCount = this.parent.querySelector('#' +this.id.inputCount);
      var inputPercentile = this.parent.querySelector('#' +this.id.inputPercentile);
      if (channel == HistogramChannel.Red) {
...
export const PhotoHistogramUtil = PhotoHistogram;